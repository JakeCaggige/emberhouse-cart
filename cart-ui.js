...
(function () {
  ...
  function start() {
    ...
    if (d) {
      ...
      if (head && !d.querySelector(".eh-scribble-wrap")) head.insertAdjacentHTML("afterend",
        '<div class="eh-scribble-wrap"><svg class="eh-scribble" viewBox="0 0 240 64" fill="none"><path d="M8 40C16 16 40 14 50 36 57 52 33 58 30 38 27 18 56 12 76 30 92 44 76 60 62 46 50 34 70 20 92 30 112 39 104 54 122 52 148 49 144 22 166 24 188 26 192 48 176 54 162 59 154 44 168 36" stroke="currentColor" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round"/></svg></div>');
